...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create tags-3185
  fly apps create tags-3185-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app tags-3185
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app tags-3185-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'tags-3185-staging' does not match app name in config file 'tags-3185'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name tags-3185-db
  fly postgres attach --app tags-3185 tags-3185-db

  fly postgres create --name tags-3185-staging-db
  fly postgres attach --app tags-3185-staging tags-3185-staging-db
  ```
